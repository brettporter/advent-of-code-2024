...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `71.9µs` | `65.7µs` |
| [Day 2](./src/bin/02.rs) | `171.1µs` | `282.2µs` |
| [Day 3](./src/bin/03.rs) | `41.8µs` | `40.6µs` |
| [Day 4](./src/bin/04.rs) | `248.7µs` | `99.1µs` |
| [Day 5](./src/bin/05.rs) | `1.3ms` | `3.8ms` |
| [Day 6](./src/bin/06.rs) | `173.1µs` | `77.3ms` |
| [Day 7](./src/bin/07.rs) | `1.7ms` | `171.3ms` |
| [Day 8](./src/bin/08.rs) | `48.3µs` | `55.2µs` |
| [Day 9](./src/bin/09.rs) | `86.2µs` | `13.0ms` |
| [Day 10](./src/bin/10.rs) | `123.1µs` | `120.4µs` |
| [Day 11](./src/bin/11.rs) | `72.3µs` | `4.9ms` |
| [Day 12](./src/bin/12.rs) | `3.4ms` | `3.0ms` |
| [Day 13](./src/bin/13.rs) | `34.0µs` | `29.8µs` |
| [Day 14](./src/bin/14.rs) | `70.0µs` | `12.4ms` |
| [Day 15](./src/bin/15.rs) | `1.0ms` | `1.1ms` |
| [Day 16](./src/bin/16.rs) | `4.9ms` | `4.7ms` |
| [Day 17](./src/bin/17.rs) | `1.4µs` | `67.4µs` |
| [Day 18](./src/bin/18.rs) | `1.0ms` | `1.0ms` |
| [Day 19](./src/bin/19.rs) | `8.7ms` | `33.7ms` |
| [Day 20](./src/bin/20.rs) | `398.6µs` | `12.9ms` |
| [Day 21](./src/bin/21.rs) | `306.9µs` | `336.8µs` |
| [Day 22](./src/bin/22.rs) | `25.6ms` | `742.6ms` |
| [Day 23](./src/bin/23.rs) | `20.6ms` | `163.6ms` |
| [Day 25](./src/bin/25.rs) | `910.0µs` | `-` |
